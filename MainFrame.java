...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        btnVendor.setBounds(541, 102, 176, 50);
        btnVendor.setBorder(new LineBorder(new Color(0, 0, 0)));
        btnVendor.setBackground(Color.CYAN);
        ...
        btnVendor.setFont(new Font("Tahoma", Font.BOLD, 24));
        ...
        lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\abina\\OneDrive\\Desktop\\background.jpg"));
